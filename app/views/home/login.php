                                ...
                                <div id="customer-login" class="content">
                                    ...
                                    <form method="post" action="/account/login" id="customer_login"
                                        ...
                                        <div class="control-wrapper">
                                            ...
                                            <input type="password" required name="customer[password]"
                                                   id="customer_password" class="password"/>
                                        </div>


                                        <div class="control-wrapper last">
                                            <div class="action">
                                                <a class="forgot-pass" href="javascript:;"
                                                   onclick="showRecoverPasswordForm()">Lost your password?</a>
                                                <a class="return-store" href="https://arena-handy.myshopify.com">Return
                                                    to Store</a>
                                            </div>
                                ...
                                <div id="recover-password" style="display: none;">
                                    ...
                                    <form method="post" action="/account/recover" accept-charset="UTF-8"><input
                                        ...
                                        <div class="control-wrapper">
                                            ...
                                            <a class="cancel btn btn-2" href="javascript:;"
